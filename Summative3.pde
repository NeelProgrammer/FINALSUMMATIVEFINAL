...
void setup()
{
  ...
  imageMode(CENTER);
  file = new SoundFile(this, "Galaga.mp3");
  file.play();
...
void draw()
{
  if (started == true);
  {
    ...
    text("Right click to start music", 0, 600);

    text("For harder levels start on 1 and then continue onward through the keys", 0, 400);
  }
